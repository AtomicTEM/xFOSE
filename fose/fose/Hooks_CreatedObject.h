...
{
	FakeModInfo(FOSESerializationInterface* _intfc);
	~FakeModInfo();

	FOSESerializationInterface* intfc;	// alternative: Fake BSFile redefining virtual funcs to use serialization intfc
